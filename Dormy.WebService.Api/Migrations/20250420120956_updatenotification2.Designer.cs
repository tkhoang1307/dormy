...
namespace Dormy.WebService.Api.Migrations
{
    ...
    [Migration("20250420120956_updatenotification2")]
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.AdminEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 9, 56, 108, DateTimeKind.Local).AddTicks(3504),
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.GuardianEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateUtc = new DateTime(2025, 4, 20, 12, 9, 56, 108, DateTimeKind.Utc).AddTicks(9336),
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.HealthInsuranceEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 9, 56, 108, DateTimeKind.Local).AddTicks(6020),
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.RoomServiceEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 3000m,
                            CreatedBy = new Guid("49e51699-8249-4cc3-899b-bb0b9773e2c3"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 9, 56, 112, DateTimeKind.Local).AddTicks(7030),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.RoomTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Capacity = 5,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 9, 56, 112, DateTimeKind.Local).AddTicks(7288),
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.RoomTypeServiceEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("76a2e471-1d2b-4a90-8d80-dfc77fe503e6"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 9, 56, 113, DateTimeKind.Local).AddTicks(361),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 9, 56, 108, DateTimeKind.Local).AddTicks(7772),
                            DateOfBirth = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.WorkplaceEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("49e51699-8249-4cc3-899b-bb0b9773e2c3"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 12, 9, 56, 108, DateTimeKind.Utc).AddTicks(5589),
                            IsDeleted = false,
