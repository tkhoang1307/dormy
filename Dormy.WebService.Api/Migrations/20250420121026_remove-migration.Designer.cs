...
namespace Dormy.WebService.Api.Migrations
{
    ...
    [Migration("20250420121026_remove-migration")]
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.AdminEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 10, 25, 625, DateTimeKind.Local).AddTicks(8727),
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.GuardianEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateUtc = new DateTime(2025, 4, 20, 12, 10, 25, 626, DateTimeKind.Utc).AddTicks(4767),
                            Email = "bacba@gmail.com",
                            IsDeleted = false,
                            Name = "Bac Ba",
                            PhoneNumber = "09737338939",
                            RelationshipToUser = "Cha",
                            UserId = new Guid("3f86e0b9-868c-49fb-a0de-a527d467a673")
                        });
                });
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.HealthInsuranceEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 10, 25, 626, DateTimeKind.Local).AddTicks(1317),
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.RoomServiceEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 3000m,
                            CreatedBy = new Guid("49e51699-8249-4cc3-899b-bb0b9773e2c3"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 10, 25, 629, DateTimeKind.Local).AddTicks(8539),
                            IsDeleted = false,
                            IsServiceIndicatorUsed = true,
                            RoomServiceName = "Water",
                            RoomServiceType = "WATER",
                            Unit = "m3"
                        });
                });
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.RoomTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Capacity = 5,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 10, 25, 629, DateTimeKind.Local).AddTicks(8880),
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.RoomTypeServiceEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4cf862f7-b455-4f29-b0be-2c6da92d1e7c"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 10, 25, 630, DateTimeKind.Local).AddTicks(1678),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 19, 10, 25, 626, DateTimeKind.Local).AddTicks(3125),
                            DateOfBirth = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "user@gmail.com",
                            FirstName = "Van",
                            Gender = "MALE",
                            HealthInsuranceId = new Guid("aabe7f9b-92ba-44ee-a73c-cae62fdfabcc"),
                            IsDeleted = false,
                            LastName = "Ba",
                            ...
                            Status = "ACTIVE",
                            UserName = "user",
                            WorkplaceId = new Guid("3ebe6594-a32f-4b10-8c4e-401a1042a1e7")
                        });
                });
            ...
            modelBuilder.Entity("Dormy.WebService.Api.Core.Entities.WorkplaceEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3ebe6594-a32f-4b10-8c4e-401a1042a1e7"),
                            Abbrevation = "20000",
                            Address = "VNG Q1 HCM City",
                            CreatedBy = new Guid("49e51699-8249-4cc3-899b-bb0b9773e2c3"),
                            CreatedDateUtc = new DateTime(2025, 4, 20, 12, 10, 25, 626, DateTimeKind.Utc).AddTicks(1018),
                            IsDeleted = false,
